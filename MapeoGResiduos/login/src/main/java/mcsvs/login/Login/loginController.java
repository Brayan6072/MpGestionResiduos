...
//Reportes del ultimo mes
    ...
    public String login(@Valid LoginRequest request, Model tokenactivo, BindingResult result) {
    ...
    public String register(@Valid RegisterRequest request,Model register){
